...
func main() {
	...
	router.HandleFunc("/usuarios/{id}/iniciais", servidor.IniciaisUsuario).Methods(http.MethodGet)
	router.HandleFunc("/usuarios/{id}/tamanho", servidor.TamanhoNome).Methods(http.MethodGet)
